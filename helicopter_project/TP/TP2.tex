...
\begin{itemize}
	\item Un pré-traitement des données est-il nécessaire (données aberrantes, ...) ?
...
\paragraph{}
Choisissez le modèle qui vous semble le mieux adapté et donnez des arguments vous ayant ammenés à faire ce choix. Attention, cela a-t-il du sens d'appliquer des méthodes \emph{leave-one-out} pour juger de la qualité d'un modèle ?
